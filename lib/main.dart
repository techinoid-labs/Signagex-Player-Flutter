...
void main() {
  ...
  // Installed before anything else starts, so a failure during startup is
  // captured too.
  //
  // Framework build/layout/paint errors go only to
  // FlutterError.dumpErrorToConsole by default, and a release player has
  // nowhere to print: a .app launched from Finder, the Dock or a login item
  // has no attached terminal, so print() and debugPrint() reach nobody. A
  // widget silently erroring and being torn down was indistinguishable from
